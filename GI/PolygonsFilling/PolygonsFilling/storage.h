...
public:
	...
	void createDbMetaHead(char *fileName, MainWindow* ui);
	void initDB(struct DbMetaHead *head, char *fileName, MainWindow *ui);
	void showDbInfo(struct DbMetaHead *head, MainWindow* ui);
	void showSegTable(struct DbMetaHead *head, int fileID, MainWindow* ui);
